                                        ...
                                        <CardBody className="p-4">
                                            ...
                                            <div className="p-2 mt-4">
                                                <div className="text-muted text-center mb-4 mx-lg-3">
                                                    <h4 className="">Verify Phone Number</h4>
                                                    <p>Please enter the 6 digit code sent to <span className="fw-semibold">+817363535</span></p>
                                                </div>
                                                ...
                                                <form>
                                                    <Row>
                                                        ...
                                                        <Col className="col-2">
                                                            <div className="mb-3">
                                                                <label htmlFor="digit4-input" className="visually-hidden">Digit 5</label>
                                                                <input type="text"
                                                                    className="p-3 form-control form-control-lg bg-light border-light text-center"
                                                                    maxLength="1"
                                                                    id="digit4-input" onKeyUp={() => moveToNext(5)} />
                                                            </div>
                                                        </Col>
                                                        <Col className="col-2">
                                                            <div className="mb-3">
                                                                <label htmlFor="digit4-input" className="visually-hidden">Digit 6</label>
                                                                <input type="text"
                                                                    className="p-3 form-control form-control-lg bg-light border-light text-center"
                                                                    maxLength="1"
                                                                    id="digit4-input" onKeyUp={() => moveToNext(6)} />
                                                            </div>
                                                        </Col>
                                                    </Row>
                                                </form>
                                                <div className="mt-3">
                                                    <Button color="success" className="w-100" onClick={() => { history(`/dashboard`); }}>Confirm</Button>
                                                </div>
                                            </div>
                                        </CardBody>
                                    </Card>
