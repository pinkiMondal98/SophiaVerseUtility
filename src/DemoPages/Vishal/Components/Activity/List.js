    ...
    const projectLists = [
        {
            ...
            imgbgColor: `warning`,
            img: activity1,
            label: `Pickup Food and Deliver`,
            caption: `pickup food and deliver to needed person and earn points`,
            number: `40/60`,
            progressBar: 100 * Number(40 / 60) + `%`,
            points: 2345,
            date: `10 Jul, 2021`,
            link: "/activities/pickup-form"
        },

        {
            ...
            imgbgColor: `danger`,
            img: activity2,
            label: `Tell us about extra Food`,
            caption: `Dont waste your Food`,
            number: `20/67`,
                            ...
                            <Card className="card-height-100">
                                <CardBody className=' card-animate'>
                                    <div className="d-flex flex-column h-100">
                                        ...
                                        <div className="d-flex mb-2" onClick={() => { item.link && history(item.link); }}>
