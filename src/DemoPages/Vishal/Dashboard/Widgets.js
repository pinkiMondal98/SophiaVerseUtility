        ...
        <React.Fragment>
            <Row>
                {/* <Col xl={3}>
                    <Row>
                        <Col xl={12}>
                                <img className="" alt="200x200" width="100%" style={{height:'7.6rem'}} src={sophiaverse1}></img>
                        </Col>
                        <Col xl={12}>
                            <Card>
                            <img className="" alt="200x200" width="100%" src={sophiaverse2}></img>
                            </Card>
                        </Col>
                    </Row>
                </Col> */}
                                ...
                                <Card className="card-animate" onClick={() => { item.link ? history(`/${item.link}`) : console.log(item.link); }}>
                                    <CardBody>
                                        <div className="flex-grow-1 overflow-hidden">
                                            <p className="text-uppercase fw-medium text-muted text-truncate mb-0 fs-12">{item.label}</p>
                                        </div>
