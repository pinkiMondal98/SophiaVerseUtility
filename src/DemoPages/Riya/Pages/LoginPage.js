...
const LoginPage = () => {
  const history = useNavigate();
    const logo = "	https://uploads-ssl.webflow.com/622c1e6eb1cd192ecedc6225/622ef0219152c96bc2ea796e_sophia-kv.jpg"
                        ...
                        <Row>
                            <Col lg={12}>
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    ...
                                    <p className="mt-3 text-white fs-15 fw-medium">Optionality and Infinite Games </p>
                                </div>
                            </Col>
                        </Row>
                                ...
                                <Card className="mt-4">
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Sign in to continue to Mindplex</p>
                                        </div>
                                        <div className="p-2 mt-4">
                                            <form action="#">
                                                ...
                                                <div className="mt-4">
                                                    <Button color="success" className="btn btn-success w-100" onClick={() => { history(`/two-step`); }} type="submit">Sign In</Button>
                                                </div>
